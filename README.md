...
The purpose of this document is provide a guide to install Augoor 1.9.1 in a single machine on AWS.
...
#### 2.- Instance Required
  ...
  - We require use of this instance type with this specifications, and the role defined in the step before assigned to the instance:
